...
// General.
$string['pluginname'] = 'theme_sos';
$string['choosereadme'] = 'This plugin is just a boilerplate template one can use to develop Boost Union child themes.';
$string['configtitle'] = 'theme_sos';
$string['settingsoverview_buc_desc'] = 'With theme_sos, you can customize Boost Union to your own local needs.';
...
$string['inheritanceoptionsexplanation'] = 'Most of the time, inheriting will be perfectly fine. However, it may happen that imperfect code is integrated into Boost Union which prevents simple SCSS inheritance for particular Boost Union features. If you encounter any issues with Boost Union features which seem not to work in theme_sos as well, try to switch this setting to \'Dupliate\' and, if this solves the problem, report an issue on Github (see the README.md file for details how to report an issue).';
...
// Privacy API.
$string['privacy:metadata'] = 'The theme_sos theme does not store any personal data about any user.';
